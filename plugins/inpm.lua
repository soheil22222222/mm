...
local function chat_list(msg)
    ...
    local message = 'لیست گپ:\nشما میتوانیداز دستور#join [ایدی گپ]\nبرای  ورد به گپ استفاده کنید '
...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "سلام\nبه خصوصی پارت بات خوش امدین شما میتوانید بازدن دستور #superhelp راهنمای سوپر گروه را دریافت کنید"
     	return text
    end
